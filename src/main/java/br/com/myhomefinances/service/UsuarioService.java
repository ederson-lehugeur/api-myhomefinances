...
public class UsuarioService {
	...
	public Usuario fromNewDTO(UsuarioNewForm usuarioNewDto) {
		return new Usuario(null, usuarioNewDto.getNome(), usuarioNewDto.getSobrenome(),
				usuarioNewDto.getEmail(), bCryptPasswordEncoder.encode(usuarioNewDto.getSenha()));
	}

	public Usuario fromUpdateDTO(UsuarioUpdateForm usuarioUpdateDto) {
		return new Usuario(null, usuarioUpdateDto.getNome(),
